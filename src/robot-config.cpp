...
motor spinnersMotorA = motor(PORT11, ratio6_1, false);
motor spinnersMotorB = motor(PORT20, ratio6_1, true);
motor_group spinners = motor_group(spinnersMotorA, spinnersMotorB);
motor ArmMotorA = motor(PORT7, ratio36_1, true);
motor ArmMotorB = motor(PORT17, ratio36_1, false);
